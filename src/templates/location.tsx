 ...
 */
const Loaction: Template<TemplateRenderProps> = ({
  relativePrefixToRoot,
  path,
  document,
}) => {
          ...
          <div>
            ...
            <div className="flex flex-col  md:flex-row  mt-16 gap-16 centered-container ">
              <div className="w-full md:w-2/3 flex flex-col gap-4">
                <div className="text-4xl font-light mb-4 text-[#003168]">
                  Welcome to the {name} branch of RBC Wealth Management
                </div>
                {c_richTextDescription && (
                  <LexicalRichText
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        <div className="flex flex-col">
                          ...
                          <a className="flex gap-2 items-center text-[#006ac3] hover:underline hover:cursor-pointer hover:bg-[#e3f4ff]">
                            <div>Find all advisor profiles here</div>
                            <IoOpenOutline />
                          </a>
                        </div>
                      </div>
                ...
                <div className="flex flex-col gap-2 mt-8">
                  {c_associatedAdvisors && (
                    <>
                      ...
                      {c_associatedAdvisors.map((item: any, index: any) => (
                        <div key={index}>
                          <div className="flex gap-2 items-center">
                            <div>
                              {item.photoGallery ? (
